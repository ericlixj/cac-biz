...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.cac";
    private static final String ARTIFACT_ID = "biz";
    private static final String PACKAGE_NAME = "com.cac.biz";
    private static final String TITLE = "统一运营管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.cac";
        String artifactIdNew = "biz";
        String packageNameNew = "com.cac.biz";
        String titleNew = "统一运营管理系统";

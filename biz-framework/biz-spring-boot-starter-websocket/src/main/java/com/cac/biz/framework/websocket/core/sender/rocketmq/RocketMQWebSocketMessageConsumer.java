package com.cac.biz.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${biz.websocket.sender-rocketmq.topic}",
        consumerGroup = "${biz.websocket.sender-rocketmq.consumer-group}",

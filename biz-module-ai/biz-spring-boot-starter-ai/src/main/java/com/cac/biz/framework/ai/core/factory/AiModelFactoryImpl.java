package com.cac.biz.framework.ai.core.factory;
...
import com.cac.biz.framework.ai.config.BizAiAutoConfiguration;
import com.cac.biz.framework.ai.config.BizAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            BizAiProperties.MidjourneyProperties properties = SpringUtil.getBean(BizAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link BizAiAutoConfiguration#deepSeekChatModel(BizAiProperties)}
     */
    ...
    /**
     * 可参考 {@link BizAiAutoConfiguration#xingHuoChatClient(BizAiProperties)}
     */

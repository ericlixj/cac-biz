package com.cac.biz.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.cac.biz.framework.common.enums.CommonStatusEnum;
import com.cac.biz.framework.common.exception.ServiceException;
import com.cac.biz.framework.common.pojo.PageResult;
import com.cac.biz.framework.common.util.collection.ArrayUtils;
import com.cac.biz.framework.common.util.collection.CollectionUtils;
import com.cac.biz.framework.test.core.ut.BaseDbUnitTest;
import com.cac.biz.module.infra.api.config.ConfigApi;
import com.cac.biz.module.infra.api.file.FileApi;
import com.cac.biz.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.cac.biz.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.cac.biz.module.system.controller.admin.user.vo.user.*;
import com.cac.biz.module.system.dal.dataobject.dept.DeptDO;
import com.cac.biz.module.system.dal.dataobject.dept.PostDO;
import com.cac.biz.module.system.dal.dataobject.dept.UserPostDO;
import com.cac.biz.module.system.dal.dataobject.tenant.TenantDO;
import com.cac.biz.module.system.dal.dataobject.user.AdminUserDO;
import com.cac.biz.module.system.dal.mysql.dept.UserPostMapper;
import com.cac.biz.module.system.dal.mysql.user.AdminUserMapper;
import com.cac.biz.module.system.enums.common.SexEnum;
import com.cac.biz.module.system.service.dept.DeptService;
import com.cac.biz.module.system.service.dept.PostService;
import com.cac.biz.module.system.service.permission.PermissionService;
import com.cac.biz.module.system.service.tenant.TenantService;
...
import static com.cac.biz.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.cac.biz.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.cac.biz.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.cac.biz.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.cac.biz.framework.test.core.util.AssertUtils.assertServiceException;
import static com.cac.biz.framework.test.core.util.RandomUtils.*;
import static com.cac.biz.module.system.enums.ErrorCodeConstants.*;
import static com.cac.biz.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("bizyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("bizyuanma");
        ...
        assertEquals("bizyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("bizyuanma"))).thenReturn("java");

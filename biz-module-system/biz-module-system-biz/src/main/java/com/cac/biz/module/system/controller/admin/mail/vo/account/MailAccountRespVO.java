package com.cac.biz.module.system.controller.admin.mail.vo.account;
...
public class MailAccountRespVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "bizyuanma@123.com")
    private String mail;

    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "biz")

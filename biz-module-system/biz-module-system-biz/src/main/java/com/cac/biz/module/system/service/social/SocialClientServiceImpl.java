...
import com.cac.biz.framework.common.util.cache.CacheUtils;
...
import com.cac.biz.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.cac.biz.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.cac.biz.module.system.dal.dataobject.social.SocialClientDO;
import com.cac.biz.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${biz.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${biz.wxa-subscribe-message.miniprogram-state:formal}")

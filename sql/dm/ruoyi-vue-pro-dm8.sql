...
INSERT INTO infra_file_config (id, name, storage, remark, master, config, creator, create_time, updater, update_time, deleted) VALUES (4, '���ݿ�', 1, '�������ݿ�', '0', '{"@class":"com.cac.biz.module.infra.framework.file.core.client.db.DBFileClientConfig","domain":"http://127.0.0.1:48080"}', '1', '2022-03-15 23:56:24', '1', '2024-02-28 22:54:07', '0');
...
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (1, 'default', 'admin123', '���Դ��', 'http://test.biz.iocoder.cn/a5e2e244368878a366b516805a4aabf1.png', '��������', 0, 1800, 2592000, '["https://www.iocoder.cn","https://doc.iocoder.cn"]', '["password","authorization_code","implicit","refresh_token"]', '["user.read","user.write"]', '[]', '["user.read","user.write"]', '[]', '{}', '1', '2022-05-11 21:47:12', '1', '2024-02-22 16:31:52', '0');
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (40, 'test', 'test2', 'biubiu', 'http://test.biz.iocoder.cn/277a899d573723f1fcdfb57340f00379.png', '��������', 0, 1800, 43200, '["https://www.iocoder.cn"]', '["password","authorization_code","implicit"]', '["user_info","projects"]', '["user_info"]', '[]', '[]', '{}', '1', '2022-05-12 00:28:20', '1', '2023-12-02 21:01:01', '0');
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (41, 'biz-sso-demo-by-code', 'test', '������Ȩ��ģʽ�����ʵ�� SSO �����¼��', 'http://test.biz.iocoder.cn/fe4ed36596adad5120036ef61a6d0153654544d44af8dd4ad3ffe8f759933d6f.png', NULL, 0, 1800, 43200, '["http://127.0.0.1:18080"]', '["authorization_code","refresh_token"]', '["user.read","user.write"]', '[]', '[]', '[]', NULL, '1', '2022-09-29 13:28:31', '1', '2022-09-29 13:28:31', '0');
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (42, 'biz-sso-demo-by-password', 'test', '��������ģʽ�����ʵ�� SSO �����¼��', 'http://test.biz.iocoder.cn/604bdc695e13b3b22745be704d1f2aa8ee05c5f26f9fead6d1ca49005afbc857.jpeg', NULL, 0, 1800, 43200, '["http://127.0.0.1:18080"]', '["password","refresh_token"]', '["user.read","user.write"]', '[]', '[]', '[]', NULL, '1', '2022-10-04 17:40:16', '1', '2022-10-04 20:31:21', '0');
COMMIT;
...
INSERT INTO system_users (id, username, password, nickname, remark, dept_id, post_ids, email, mobile, sex, avatar, status, login_ip, login_date, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (100, 'biz', '$2a$10$11U48RhyJ5pSBYWSn12AD./ld671.ycSzJHbyrtpeoMeYiw31eo8a', '���', '��Ҫ����', 104, '[1]', 'biz@iocoder.cn', '15601691300', 1, '', 1, '127.0.0.1', '2022-07-09 23:03:33', '', '2021-01-07 09:07:17', NULL, '2022-07-09 23:03:33', '0', 1);
...
COMMENT ON COLUMN biz_demo01_contact.id IS '���';
COMMENT ON COLUMN biz_demo01_contact.name IS '����';
COMMENT ON COLUMN biz_demo01_contact.sex IS '�Ա�';
COMMENT ON COLUMN biz_demo01_contact.birthday IS '������';
COMMENT ON COLUMN biz_demo01_contact.description IS '���';
COMMENT ON COLUMN biz_demo01_contact.avatar IS 'ͷ��';
COMMENT ON COLUMN biz_demo01_contact.creator IS '������';
COMMENT ON COLUMN biz_demo01_contact.create_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo01_contact.updater IS '������';
COMMENT ON COLUMN biz_demo01_contact.update_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo01_contact.deleted IS '�Ƿ�ɾ��';
COMMENT ON COLUMN biz_demo01_contact.tenant_id IS '�⻧���';
COMMENT ON TABLE biz_demo01_contact IS 'ʾ����ϵ�˱�';

-- ----------------------------
-- Records of biz_demo01_contact
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT biz_demo01_contact ON;
INSERT INTO biz_demo01_contact (id, name, sex, birthday, description, avatar, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, '����', 2, '2023-11-07 00:00:00', '<p>���������ѽ</p>', 'http://127.0.0.1:48080/admin-api/infra/file/4/get/46f8fa1a37db3f3960d8910ff2fe3962ab3b2db87cf2f8ccb4dc8145b8bdf237.jpeg', '1', '2023-11-15 23:34:30', '1', '2023-11-15 23:47:39', '0', 1);
COMMIT;
SET IDENTITY_INSERT biz_demo01_contact OFF;
-- @formatter:on
...
COMMENT ON COLUMN biz_demo02_category.id IS '���';
COMMENT ON COLUMN biz_demo02_category.name IS '����';
COMMENT ON COLUMN biz_demo02_category.parent_id IS '�������';
COMMENT ON COLUMN biz_demo02_category.creator IS '������';
COMMENT ON COLUMN biz_demo02_category.create_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo02_category.updater IS '������';
COMMENT ON COLUMN biz_demo02_category.update_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo02_category.deleted IS '�Ƿ�ɾ��';
COMMENT ON COLUMN biz_demo02_category.tenant_id IS '�⻧���';
COMMENT ON TABLE biz_demo02_category IS 'ʾ�������';

-- ----------------------------
-- Records of biz_demo02_category
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT biz_demo02_category ON;
INSERT INTO biz_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, '����', 0, '1', '2023-11-15 23:34:30', '1', '2023-11-16 20:24:23', '0', 1);
INSERT INTO biz_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, '����', 0, '1', '2023-11-16 20:24:00', '1', '2023-11-16 20:24:15', '0', 1);
INSERT INTO biz_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (3, '�ֹ�', 0, '1', '2023-11-16 20:24:32', '1', '2023-11-16 20:24:32', '0', 1);
INSERT INTO biz_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (4, 'С����', 2, '1', '2023-11-16 20:24:39', '1', '2023-11-16 20:24:39', '0', 1);
INSERT INTO biz_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (5, '����', 2, '1', '2023-11-16 20:24:46', '1', '2023-11-16 20:24:46', '0', 1);
...
COMMIT;
SET IDENTITY_INSERT biz_demo02_category OFF;
-- @formatter:on
...
COMMENT ON COLUMN biz_demo03_course.id IS '���';
COMMENT ON COLUMN biz_demo03_course.student_id IS 'ѧ�����';
COMMENT ON COLUMN biz_demo03_course.name IS '����';
COMMENT ON COLUMN biz_demo03_course.score IS '����';
COMMENT ON COLUMN biz_demo03_course.creator IS '������';
COMMENT ON COLUMN biz_demo03_course.create_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_course.updater IS '������';
COMMENT ON COLUMN biz_demo03_course.update_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_course.deleted IS '�Ƿ�ɾ��';
COMMENT ON COLUMN biz_demo03_course.tenant_id IS '�⻧���';
COMMENT ON TABLE biz_demo03_course IS 'ѧ���γ̱�';

-- ----------------------------
-- Records of biz_demo03_course
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT biz_demo03_course ON;
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, 2, '����', 66, '1', '2023-11-16 23:21:49', '1', '2023-11-16 23:21:49', '0', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (3, 2, '��ѧ', 22, '1', '2023-11-16 23:21:49', '1', '2023-11-16 23:21:49', '0', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (6, 5, '����', 23, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:44:40', '1', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 5, '�����', 11, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:44:40', '1', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (8, 5, '����', 23, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:47:09', '1', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 5, '�����', 11, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:47:09', '1', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (10, 5, '����', 23, '1', '2023-11-16 23:22:46', '1', '2023-11-16 23:47:10', '0', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (11, 5, '�����', 11, '1', '2023-11-16 23:22:46', '1', '2023-11-16 23:47:10', '0', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (12, 2, '����', 33, '1', '2023-11-17 00:20:42', '1', '2023-11-16 16:20:45', '1', 1);
INSERT INTO biz_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (13, 9, '��ѩ', 12, '1', '2023-11-17 13:13:20', '1', '2023-11-17 13:13:20', '0', 1);
COMMIT;
SET IDENTITY_INSERT biz_demo03_course OFF;
-- @formatter:on
...
COMMENT ON COLUMN biz_demo03_grade.id IS '���';
COMMENT ON COLUMN biz_demo03_grade.student_id IS 'ѧ�����';
COMMENT ON COLUMN biz_demo03_grade.name IS '����';
COMMENT ON COLUMN biz_demo03_grade.teacher IS '������';
COMMENT ON COLUMN biz_demo03_grade.creator IS '������';
COMMENT ON COLUMN biz_demo03_grade.create_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_grade.updater IS '������';
COMMENT ON COLUMN biz_demo03_grade.update_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_grade.deleted IS '�Ƿ�ɾ��';
COMMENT ON COLUMN biz_demo03_grade.tenant_id IS '�⻧���';
COMMENT ON TABLE biz_demo03_grade IS 'ѧ���༶��';

-- ----------------------------
-- Records of biz_demo03_grade
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT biz_demo03_grade ON;
INSERT INTO biz_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 2, '���� 2 ��', '�ܽ���', '1', '2023-11-16 23:21:49', '1', '2023-11-16 23:21:49', '0', 1);
INSERT INTO biz_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (8, 5, '��Ϊ', 'ңң����', '1', '2023-11-16 23:22:46', '1', '2023-11-16 23:47:10', '0', 1);
INSERT INTO biz_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 9, 'Сͼ', 'С��111', '1', '2023-11-17 13:10:23', '1', '2023-11-17 13:10:23', '0', 1);
COMMIT;
SET IDENTITY_INSERT biz_demo03_grade OFF;
-- @formatter:on
...
COMMENT ON COLUMN biz_demo03_student.id IS '���';
COMMENT ON COLUMN biz_demo03_student.name IS '����';
COMMENT ON COLUMN biz_demo03_student.sex IS '�Ա�';
COMMENT ON COLUMN biz_demo03_student.birthday IS '��������';
COMMENT ON COLUMN biz_demo03_student.description IS '���';
COMMENT ON COLUMN biz_demo03_student.creator IS '������';
COMMENT ON COLUMN biz_demo03_student.create_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_student.updater IS '������';
COMMENT ON COLUMN biz_demo03_student.update_time IS '����ʱ��';
COMMENT ON COLUMN biz_demo03_student.deleted IS '�Ƿ�ɾ��';
COMMENT ON COLUMN biz_demo03_student.tenant_id IS '�⻧���';
COMMENT ON TABLE biz_demo03_student IS 'ѧ����';

-- ----------------------------
-- Records of biz_demo03_student
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT biz_demo03_student ON;
INSERT INTO biz_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, 'С��', 1, '2023-11-16 00:00:00', '<p>����</p>', '1', '2023-11-16 23:21:49', '1', '2023-11-17 16:49:06', '0', 1);
INSERT INTO biz_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (5, '���', 2, '2023-11-13 00:00:00', '<p>���ڽ�������?</p>', '1', '2023-11-16 23:22:46', '1', '2023-11-17 16:49:07', '0', 1);
INSERT INTO biz_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 'С��', 1, '2023-11-07 00:00:00', '<p>������</p>', '1', '2023-11-17 00:04:47', '1', '2023-11-17 16:49:08', '0', 1);
COMMIT;
SET IDENTITY_INSERT biz_demo03_student OFF;
-- @formatter:on

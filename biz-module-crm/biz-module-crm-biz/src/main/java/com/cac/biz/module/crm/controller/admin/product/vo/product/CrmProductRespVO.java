package com.cac.biz.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.cac.biz.module.system.dal.dataobject.user.AdminUserDO",

package com.cac.biz.module.mp.service.account;
...
import com.cac.biz.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.cac.biz.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.cac.biz.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.cac.biz.module.mp.convert.account.MpAccountConvert;
import com.cac.biz.module.mp.dal.dataobject.account.MpAccountDO;
import com.cac.biz.module.mp.dal.mysql.account.MpAccountMapper;
import com.cac.biz.module.mp.enums.ErrorCodeConstants;
...
import static com.cac.biz.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 biz-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }

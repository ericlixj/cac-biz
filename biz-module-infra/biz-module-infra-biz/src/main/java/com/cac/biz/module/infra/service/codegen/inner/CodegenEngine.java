package com.cac.biz.module.infra.service.codegen.inner;
...
import com.cac.biz.framework.apilog.core.enums.OperateTypeEnum;
...
import com.cac.biz.framework.excel.core.annotations.DictFormat;
import com.cac.biz.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "biz-module-${table.moduleName}/" + // 顶级模块
                "biz-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "biz-module-${table.moduleName}/" + // 顶级模块
                "biz-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "biz-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "biz-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }

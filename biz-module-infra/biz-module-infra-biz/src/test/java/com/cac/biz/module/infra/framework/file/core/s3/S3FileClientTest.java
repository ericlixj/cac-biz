package com.cac.biz.module.infra.framework.file.core.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.biz.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.biz.iocoder.cn
        // 默认上海的 endpoint

package com.cac.biz.module.infra.service.logger;
...
import com.cac.biz.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.cac.biz.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.cac.biz.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.cac.biz.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.cac.biz.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.cac.biz.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("biz-test");
